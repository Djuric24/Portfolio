const SocialMediaIcons = () => {
  return (
    <div className="flex h-20 justify-center md:justify-start my-10 gap-7">
      <a
        className="hover:opacity-50 transition duration-500"
        href="https://www.linkedin.com/in/aleksandar-djuric-b72430159/"
        target="_blank"
        rel="noreferrer"
      >
